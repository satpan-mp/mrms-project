...
| TD-020 | Pino sensitive-data redaction + Prisma query logging not yet configured | Not needed until auth/DB-query features exist | Add pino `redact` (authorization/cookie/token) + Prisma `log` events at Sprint 1B start | L | Open |
